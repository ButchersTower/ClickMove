...
public class PathFind {
	...
	// direction.
	int[] eN = { -1, 3, 7, 8, 20, 21 };
	int[] eE = { -1, 4, 6, 8, 22, 23 };
	int[] eS = { -1, 1, 5, 6, 17, 24 };
	int[] eW = { -1, 2, 5, 7, 18, 19 };

	/**
	 * eE is the same as xW
	 */
	...
	int[] xNW = { 1, 4, 5, 6, 8, 16 };
	int[] xNE = { 1, 2, 5, 6, 7, 13 };
	int[] xSE = { 2, 3, 5, 7, 8, 14 };
	int[] xSW = { 3, 4, 6, 7, 8, 15 };

	static int[] impBlocks = { 9, 10, 11, 12, 100 };
	...
	void conCheck() {
		...
		if (!pathComplete) {
			...
			// if there is a number of turns till i hit the next node then move acordingly.
			if (ga > 0) {
				ga -= 1;
				// if the player is walking adjacently
				if (cx == 0) {
					if (cy < 0) {
						dy += 8;
					}
